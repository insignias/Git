<link href="resources/css/common/GeneralStyle.css" rel="stylesheet">
	...
	<div class="wrapper">
			...
			<div class="content">
					...
					<div id="form_wrapper" class="form_wrapper">
						<h3>Forgot Password Error Page:</h3>										
								<div class="row">
									<label>${emailMessage}</label>
								</div>
								<div class="row">
									<label>An error has occurred. Please enter correct email Id, if the error still persists then please contact customer care 774.287.9345</label>
								</div>
								<div class="clear"></div>
